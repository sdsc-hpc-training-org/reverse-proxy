...
## reverse proxy jupyter lab. This batch script creates the jupyter
## lab on a compute node, while the start notebook script is used to
## submit this batch script. You should never submit this batch script on
## its own, e.g. `sbatch torque/jupyterlab.sh`. Don't do that :). You can
